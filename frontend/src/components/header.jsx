  ...
  return (
    <div>
      <div className="header flex items-center justify-between">
        ...
        <div className="hidden sm:flex md:flex lg:flex">
          ...
          >
            ...
            <div className="mx-2">
              {user || userdata ? userdata.user.name : "Login"}
            </div>
          </Link>
        </div>
        <div
      ...
      <div
        className={
          isOpen
            ? "menu absolute w-full z-50 dark:bg-dark dark:text-light text-dark bg-light"
            : "hidden"
        }
      >
        <div className="flex flex-col">
          <Link
            to={"/"}
            className=" rounded-full text-lg px-3 py-0.5 m-2"
            onClick={togglemenu}
          >
            Home
          </Link>
